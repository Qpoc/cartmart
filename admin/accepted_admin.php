...
<head>
    ...
    <link rel="stylesheet" href="css/responsive/accepted_admin-responsive.css">
    ...
    <main>
        ...
        <div class='wrapper'>
            ...
            <div class='navigation'>
                <nav>
                    <li><a href="admin.php">Pending Admin</a></li>
                    <li><a href="accepted_admin.php" class="active">Admin</a></li>
                </nav>
            </div>
