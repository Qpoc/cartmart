...
<head>
    ...
    <link rel="stylesheet" href="css/responsive/accepted_rider-responsive.css">
    ...
    <main>
        ...
        <div class='wrapper'>
            ...
            <div class='navigation'>
                <nav>
                    <li><a href="rider.php">Pending Rider</a></li>
                    <li><a href="accepted_rider.php" class="active">Rider</a></li>
                </nav>
            </div>
