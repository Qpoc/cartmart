...
function getHTMLProdString($productid, $branchid, $title, $price, $productimage) {
    ...
    " . $wishlist . "<input type='submit' class='btnBuy' value='Buy Now' name='btnBuy' onclick=\"buyNow('$productid')\"/>
